...
- The local Electron development app must be ad-hoc signed with `electron/SusuraDevElectron.entitlements` before app-level Core Audio capture can be tested.
