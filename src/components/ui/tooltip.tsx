...
function TooltipContent({
  ...
  if (
    ...
    const suppressedAt = Number(
      document.documentElement.dataset.caulSuppressTooltipsAt ?? 0
    )
    ...
    if (
      ...
      Date.now() - suppressedAt < tooltipSuppressionStaleMs
    ) {
      return null
    }
  }
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Positioner
        ...
        className="isolate z-[2147483647]"
      >
