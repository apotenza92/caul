...
const tabsTriggerVariants = cva("", {
  variants: {
    activeVariant: {
      default: "",
      primary:
        "data-active:!bg-primary data-active:!text-primary-foreground data-active:shadow-sm data-active:hover:!bg-primary/90 dark:data-active:!bg-primary dark:data-active:!text-primary-foreground dark:data-active:hover:!bg-primary/90",
    },
  },
  defaultVariants: {
