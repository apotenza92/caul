...
Susura is a simple, private way to use AI during live calls. It prioritises fast local transcription models where practical, and for now uses your existing ChatGPT subscription for the AI model.
