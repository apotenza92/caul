...
- Add timestamped updater lifecycle and Windows process evidence plus a manual, read-only x64 updater audit that cannot publish, with separate finite bounds for download, installation, relaunch and uninstall.
