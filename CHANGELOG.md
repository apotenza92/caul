...
- Added signed macOS automatic updates and explicit Windows/Linux package downloads that verify the selected asset against the immutable release SHA-256 manifest before revealing it to the user.
